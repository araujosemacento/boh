<script lang="ts">
	...
	import { flavorLabels, flavorDescriptions, type Flavor, type ThemeOption, palettes } from '$lib/themes/catppuccin';
	import { Settings, X, Sun, Moon, Coffee, Smartphone } from 'lucide-svelte';
